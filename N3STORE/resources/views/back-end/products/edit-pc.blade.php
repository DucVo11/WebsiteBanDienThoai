					...
					@endif
						<form action="" method="POST" role="form" enctype="multipart/form-data">
				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row" style="color:#367fa9; font-weight: bold;"><br>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Khuyến mại 1 : <input type="text" name="txtpromo1" id="inputtxtpromo1" value="{!! old('txtpromo1',isset($pro["promo1"]) ? $pro["promo1"] : null) !!}" class="form-control" style="margin-top:5%">
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Khuyến mại 2 : <input type="text" name="txtpromo2" id="inputtxtpromo2" value="{!! old('txtpromo2',isset($pro["promo2"]) ? $pro["promo2"] : null) !!}" class="form-control" style="margin-top:5%">
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Khuyến mại 3 : <input type="text" name="txtpromo3" id="inputtxtpromo3" value="{!! old('txtpromo3',isset($pro["promo3"]) ? $pro["promo3"] : null) !!}" class="form-control" style="margin-top:5%">
					      			</div>
					      		</div>				      			
				      		</div>
				      		<div class="form-group">				      			
				      			<div class="row" style="color:#367fa9; font-weight: bold;"><br>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Hình ảnh : <input type="file" name="txtimg" accept="image/png" id="inputtxtimg"  class="form-control" style="margin-top:5%;padding:5px">
				      		...
				      		<div class="form-group"><br>
				      			...
				      			<div class="row" style="color:#367fa9; font-weight: bold;"><br>
				      				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				Mainboard : <input type="text" name="txtScreen" id="inputtxtscreen" value="{!! old('txtScreen',isset($pro->pro_details->screen) ? $pro->pro_details->screen : null) !!}"  class="form-control" style="margin-top:5%; width:550px">
					      			</div>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				Cpu : <input type="text" name="txtCpu" id="inputtxtCpu" value="{!! old('txtCpu',isset($pro->pro_details->cpu) ? $pro->pro_details->cpu : null) !!}" class="form-control" style="margin-top:5%; ">
					      			</div>					      			
					      								      			
					      		</div>
					      		<div class="row" style="color:#367fa9; font-weight: bold;"><br>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				RAM : <input type="text" name="txtRam" id="inputtxtRam" value="{!! old('txtRam',isset($pro->pro_details->ram) ? $pro->pro_details->ram : null) !!}" class="form-control" style="margin-top:5%; ">
					      			</div>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      		...
					      		<div class="row" style="color:#367fa9; font-weight: bold;">	<br>				      			
					      			<div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
					      				Lưu trữ : <input type="text" name="txtStorage" id="inputtxtStorage" value="{!! old('txtStorage',isset($pro->pro_details->storage) ? $pro->pro_details->storage : null) !!}" class="form-control" style="margin-top:5%; ">
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				FAN - Tản nhiệt <input type="text" name="txtCam1" id="inputtxtCam1" value="{!! old('txtCam1',isset($pro->pro_details->cam1) ? $pro->pro_details->cam1 : null) !!}" class="form-control" style="margin-top:5%; ">
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Nguồn (PSU) <input type="text" name="txtCam2" id="inputtxtCam2" value="{!! old('txtCam2',isset($pro->pro_details->cam2) ? $pro->pro_details->cam2 : null) !!}"" class="form-control" style="margin-top:5%; ">
					      			</div>
					      		</div>
					      		<div class="row" style="color:#367fa9; font-weight: bold;"><br>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      			...
					      			<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="padding-left: 0;">
					      				Pin : <input type="text" name="txtExtend" id="inputtxtExtend" value="{!! old('txtExtend',isset($pro->pro_details->exten_memmory) ? $pro->pro_details->exten_memmory : null) !!}" class="form-control" style="margin-top:10.5%; ">
					      			</div>
					      			<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					      				Hệ điều hành : <input type="text" name="txtOs" id="inputtxtOs" value="{!! old('txtOs',isset($pro->pro_details->os) ? $pro->pro_details->os : null) !!}" class="form-control" style="margin-top:10.5%; ">
					      			</div>
					      		</div>				      			
				      		</div><br>
				      		<div class="form-group">
				      			...
				      			<div class="row">
					      			@foreach($pro->detail_img as $row)
					      				<?php $stt++; ?>
					      				<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">						 
						      				Ảnh cũ: {!!$stt!!}<img src="{!!url('uploads/products/details/'.$row->images_url)!!}" alt="{!!$row->images_url!!}" width="80" height="60" style="margin-top:10%; padding:5px">
						      			</div>
					      			@endforeach
					      		</div>
					      		<div class="row">
