					...
					@endif
						<form action="" method="POST" role="form" enctype="multipart/form-data">
				      		...
				      		<div class="form-group"><br>
				      			...
				      			<div class="row" style="color:#367fa9; font-weight: bold;"><br>
				      				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      			Bộ nhớ trong : <input type="text" name="txtScreen" id="inputtxtscreen" value="{{ old('txtScreen') }}" class="form-control" style="margin-top:5%; width:550px">
					      			</div>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      			Thẻ nhớ : <input type="text" name="txtCpu" id="inputtxtCpu" value="{{ old('txtCpu') }}" class="form-control" style="margin-top:5%; " >
					      			</div>					      			
					      								      			
					      		</div>
					      		<div class="row" style="color:#367fa9; font-weight: bold;"><br>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				RAM : <input type="text" name="txtRam" id="inputtxtRam" value="{{ old('txtRam') }}" class="form-control" style="margin-top:5%; ">
					      			</div>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      		...
					      		<div class="row" style="color:#367fa9; font-weight: bold;">	<br>				      			
					      			...
					      			Cammera sau : <input type="text" name="txtStorage" id="inputtxtStorage" value="{{ old('txtStorage') }}" class="form-control" style="margin-top:5%; " >
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
									  Cammera trước : <input type="text" name="txtCam1" id="inputtxtCam1" value="{{ old('txtCam1') }}" class="form-control" style="margin-top:5%; "  >
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
									  SIM hỗ trợ : <input type="text" name="txtCam2" id="inputtxtCam2" value="{{ old('txtCam2') }}" class="form-control" style="margin-top:5%; " >
					      			</div>
					      		</div>
					      		<div class="row" style="color:#367fa9; font-weight: bold;"><br>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      			...
					      			<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					      				Pin : <input type="text" name="txtCase" id="inputtxtCase" value="{{ old('txtCase') }}" class="form-control" style="margin-top:10.5%; " >
					      			</div>
					      			<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">
					      			...
					      			<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="color:#367fa9; font-weight: bold;"><br>
					      				Hình ảnh {!!$i!!} : <input type="file" name="txtdetail_img[]" value="{{ old('txtdetail_img[]') }}" accept="image/png" id="inputtxtdetail_img" class="form-control" style="margin-top:10%; padding:5px">
					      			</div>
					      			@endfor
					      		</div>				      			
				      		</div><br>
